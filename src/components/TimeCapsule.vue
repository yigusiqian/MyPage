<template>
    ...
    <a-space size="small" direction="vertical">
        <el-text size="large">时光胶囊(每5分钟刷新)</el-text>
        <el-text>当前日期：{{ currentDate }}---距离新年还有 {{ daysToNewYear }} 天</el-text>
        <el-text>当前年份：{{ currentYear }}</el-text>
        <el-text>当前月份：{{ currentMonth }}</el-text>
        <el-text>当日日期：{{ currentDay }}</el-text>
